...
model.history.save_global_best_fitness_chart(filename="GWO/gbfc")
model.history.save_runtime_chart(filename="GWO/rtc")
model.history.save_exploration_exploitation_chart(filename="GWO/eec")
