...
epoch = 120
pop_size = 100
model = OriginalACOR(epoch, pop_size)
...
model.history.save_global_best_fitness_chart(filename="ACOR/gbfc")
model.history.save_runtime_chart(filename="ACOR/rtc")
model.history.save_exploration_exploitation_chart(filename="ACOR/eec")
